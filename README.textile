...
Preferences:
{:git=>true, :railsapps=>"none", :dev_webserver=>"unicorn", :prod_webserver=>"unicorn", :database=>"mongodb", :orm=>"mongoid", :templates=>"haml", :unit_test=>"rspec", :integration=>"none", :fixtures=>"none", :frontend=>"bootstrap", :bootstrap=>"less", :email=>"gmail", :authentication=>"omniauth", :omniauth_provider=>"google-oauth2", :authorization=>"cancan", :form_builder=>"simple_form", :starter_app=>"users_app", :ban_spiders=>true, :rvmrc=>true}
